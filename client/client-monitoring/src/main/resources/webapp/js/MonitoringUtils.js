...
function papDialogForm_activate(formParent, message) {
    ...
    headingSpan.innerHTML = "PAP Engine Configuration";
    ...
    urlLabel.setAttribute("for", "papDialogUrlInput");
    urlLabel.innerHTML = "Pap Engine rest URL:";
    ...
    var engineUrl = localStorage.getItem("pap-monitor-services_old");
