...
public class PapMonitoringRestResource {
    ...
    public Response createSession(@QueryParam("useHttps") final String useHttps,
        ...
        return Response
                .ok(getHttpClient(useHttps, hostname, port, username, password).get("policy/pap/v1/pdps").getEntity(),
    ...
    public Response getStatistics(@QueryParam("useHttps") final String useHttps,
        ...
        String entity = getHttpClient(useHttps, hostname, port, username, password)
                .get("policy/pap/v1/pdps/statistics/" + id + "/latest").readEntity(String.class);
