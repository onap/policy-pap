...
/**
 * This class reads and handles command line parameters to the Pap RESTful services.
 */
public class PapMonitoringRestParameterParser {
     ...
     */
    public PapMonitoringRestParameterParser() {
        options = new Options();
        options.addOption("h", "help", false, "outputs the usage of this command");
        options.addOption(Option.builder("p").longOpt("port").desc("port to use for the Pap Services REST calls")
     ...
     */
    public PapMonitoringRestParameters parse(final String[] args) {
        ...
        final PapMonitoringRestParameters parameters = new PapMonitoringRestParameters();
        ...
        try {
            ...
            throw new PapMonitoringRestParameterException("error parsing argument \"port\" :" + e.getMessage(), e);
        }
        try {
            ...
            throw new PapMonitoringRestParameterException("error parsing argument \"time-to-live\" :" + e.getMessage(),
                    e);
        }
