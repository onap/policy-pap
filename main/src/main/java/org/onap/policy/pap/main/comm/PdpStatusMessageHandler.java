...
public class PdpStatusMessageHandler extends PdpMessageGenerator {
    ...
    private void handlePdpHeartbeat(final PdpStatus message, final PolicyModelsProvider databaseProvider)
        ...
        if (pdpStatistics != null) {
            processPdpStatisticsDetails(message, pdpStatistics, databaseProvider);
        } else {
    ...
    private boolean validatePdpStatisticsDetails(final PdpStatistics pdpStatistics) {
        return pdpStatistics.getPdpInstanceId() != null && pdpStatistics.getTimeStamp() != null
                && pdpStatistics.getPdpGroupName() != null && pdpStatistics.getPdpSubGroupName() != null;
    }
