    ...
    public class ModifyReqData extends RequestData {
        ...
        public ModifyReqData(PdpUpdate update, PdpStateChange stateChange) {
            ...
            if (update != null) {
                ...
                configure(new UpdateData(update));

            } else {
                this.update = null;
                setName(stateChange.getName());
                configure(new StateChangeData(stateChange));
            }
        }
        ...
        private void add(PdpUpdate newRequest) {
            ...
            synchronized (modifyLock) {
                ...
                configure(new UpdateData(newRequest));
        ...
        private void add(PdpStateChange newRequest) {
            ...
            synchronized (modifyLock) {
                ...
                if (getWrapper() instanceof StateChangeData) {
                    ...
                    configure(new StateChangeData(newRequest));
         ...
         * Wraps an UPDATE.
         */
        private class UpdateData implements MessageData {

            public UpdateData(PdpUpdate message) {
                update = message;
            }
         ...
         */
        private class StateChangeData implements MessageData {

            public StateChangeData(PdpStateChange message) {
                stateChange = message;
            }
            ...
            @Override
            public String getType() {
                return stateChange.getClass().getSimpleName();
            }
