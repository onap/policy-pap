...
public class PdpModifyRequestMap {
    ...
    public PdpModifyRequestMap() {
        ...
        params = Registry.get(PapConstants.REG_PDP_PARAMETERS, PdpParameters.class);
        updateTimers = Registry.get(PapConstants.REG_PDP_UPDATE_TIMERS, TimerManager.class);
        stateChangeTimers = Registry.get(PapConstants.REG_PDP_STATE_CHANGE_TIMERS, TimerManager.class);
    }
    ...
    public class ModifyReqData extends RequestData {
        ...
        private class UpdateWrapper implements MessageWrapper {
            ...
            public int getMaxRetryCount() {
                return params.getUpdateParameters().getMaxRetryCount();
            }
        ...
        private class StateChangeWrapper implements MessageWrapper {
            ...
            @Override
            public int getMaxRetryCount() {
                return params.getStateChangeParameters().getMaxRetryCount();
            }
