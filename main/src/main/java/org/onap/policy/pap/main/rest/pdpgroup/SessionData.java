...
public class SessionData {
    ...
    /**
     * Gets the identified policies.
     *
     * @param desiredPolicy policy identifier, with optional version
     * @return the policies
    ...
    public ToscaPolicy getPolicyMaxVersion(String name) throws PfModelException {
        ToscaPolicyFilter filter = new ToscaPolicyFilter();
        // TODO setLatest, setActive?, setName
    ...
    public PdpGroup getPdpGroupMaxVersion(String name) throws PfModelException {
        PdpGroupFilter filter = new PdpGroupFilter();
        // TODO setLatest, setName
     ...
     *
     * @param policyType desired policy type
     * @param policyTypeVersion desired policy version
     * @return the active groups supporting the given policy
     * @throws PfModelException if an error occurs
     */
    public List<PdpGroup> getActivePdpGroupsByPolicyType(String policyType, String policyTypeVersion)
                    throws PfModelException {

        PdpGroupFilter filter = new PdpGroupFilter();
        // TODO setActive, setSupportedPolicyType, setTypeSupportedPolicyTypeVersion,
        // setHasPdps
