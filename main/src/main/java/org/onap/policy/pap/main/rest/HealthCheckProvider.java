...
public class HealthCheckProvider {
     ...
     *
     * @param checkPapDatabaseConnectivity flag to enable pap to db connectivity verification
     * @return Report containing health check status
     */
    public HealthCheckReport performHealthCheck(boolean checkPapDatabaseConnectivity) {
        ...
        if (checkPapDatabaseConnectivity) {
            alive = alive && verifyPapDatabaseConnectivity();
        }
     ...
     */
    private boolean verifyPapDatabaseConnectivity() {
        try {
