...
public class PapRestServer implements Startable {
    ...
    private Properties getServerProperties() {
        ...
        final String svcpfx = PolicyEndPointProperties.PROPERTY_HTTP_SERVER_SERVICES + SEPARATOR
        ...
        props.setProperty(svcpfx + ".restClasses", PapRestController.class.getCanonicalName());
