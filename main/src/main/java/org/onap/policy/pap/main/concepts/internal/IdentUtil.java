...
public class IdentUtil {
    public static final String NULL_INTERNAL_NAME = PfConceptKey.getNullKey().getName();
    public static final String NULL_INTERNAL_VERSION = PfConceptKey.getNullKey().getVersion();

    public static final String NULL_EXTERNAL_NAME = "";
    public static final String NULL_EXTERNAL_VERSION = null;
    ...
    public static String nameToExternal(String name) {
        return (NULL_INTERNAL_NAME.equals(name) ? "" : name);
    }
    ...
    public static String versionToExternal(String version) {
        return (NULL_INTERNAL_VERSION.equals(version) ? null : version);
    }
    ...
    public static void toInternal(String name, String version, PfConceptKey target) {
        target.setName(StringUtils.isBlank(name) ? NULL_INTERNAL_NAME : name);
        target.setVersion(StringUtils.isBlank(version) ? NULL_INTERNAL_VERSION : version);
    }
}
