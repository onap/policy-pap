...
public class PdpGroupDeleteControllerV1 extends PapRestControllerV1 {
    ...
    @Autowired
    private PdpGroupDeleteProvider provider;
     ...
     */
    private ResponseEntity<PdpGroupDeleteResponse> doOperation(String requestId, String errmsg,
     ...
     */
    private ResponseEntity<PdpGroupDeployResponse> doUndeployOperation(String requestId, String errmsg,
        RunnableWithPfEx runnable) {
        try {
            runnable.run();
