 ...
 */
public class HealthCheckReq extends RequestImpl {
     ...
     */
    public HealthCheckReq(RequestParams params, String name, PdpMessage message) {
        super(params, name, message);
    }

    @Override
    public PdpHealthCheck getMessage() {
        return (PdpHealthCheck) super.getMessage();
    }
    ...
    public boolean isSameContent(Request other) {
        if (!(other instanceof HealthCheckReq)) {
            return false;
        }
