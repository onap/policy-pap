...
public abstract class PolicyCommonTracker {
     ...
     * removed.
     */
    private final Map<ToscaPolicyIdentifier, PolicyTrackerData> policy2data = new HashMap<>();
    ...
    /**
     * Determines if the policy update is complete, based on the state of its data.
     *
     * @param PDP whose response was just processed
