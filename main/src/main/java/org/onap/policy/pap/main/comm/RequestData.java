...
public abstract class RequestData {
     ...
     */
    protected final PdpCommObjects comm;
     ...
     */
    public RequestData(PdpCommObjects comm) {
        this.comm = comm;
    }
    ...
    protected void configure(MessageWrapper newWrapper) {
        ...
        this.svcmgr = new ServiceManager(name + " " + msgType)
                        .addAction("listener",
                            () -> comm.registerListener(reqid, this::processResponse),
                            () -> comm.unregisterListener(reqid))
                        .addAction("timer",
    ...
    private void processResponse(CommInfrastructure infra, String topic, PdpStatus response) {
        ...
        synchronized (comm.getPdpLock()) {
            ...
            if (reason != null) {
                ...
                comm.stopPdp(response.getName(), reason);
            }
