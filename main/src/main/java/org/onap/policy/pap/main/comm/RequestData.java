...
public abstract class RequestData {
    ...
    /**
     * PDP response dispatcher.
     */
    private final RequestIdDispatcher<PdpStatus> responseDispatcher;
    ...
    public RequestData() {
        publisher = Registry.get(PapConstants.REG_PDP_PUBLISHER, Publisher.class);
        responseDispatcher = Registry.get(PapConstants.REG_PDP_PUBLISHER, RequestIdDispatcher.class);
        modifyLock = Registry.get(PapConstants.REG_PDP_PUBLISHER, Object.class);
    }
    ...
    protected void configure(MessageWrapper newWrapper) {
        ...
        this.svcmgr = new ServiceManager(name + " " + msgType)
                        .addAction("listener",
                            () -> responseDispatcher.register(reqid, this::processResponse),
                            () -> responseDispatcher.unregister(reqid))
                        .addAction("timer",
