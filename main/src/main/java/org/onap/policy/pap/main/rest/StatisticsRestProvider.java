...
public class StatisticsRestProvider {
    ...
    public Map<String, Map<String, List<PdpStatistics>>> fetchDatabaseStatistics(String groupName, String subType,
        ...
        try (PolicyModelsProvider databaseProvider = modelProviderWrapper.create()) {
            ...
            if (groupName == null) {
                pair = generatePdpStatistics(databaseProvider.getPdpStatistics(pdpName, startTime));
            } else {
                pair = generatePdpStatistics(databaseProvider.getFilteredPdpStatistics(pdpName, groupName, subType,
                        startTime, endTime, DESC_ORDER, recordCount));
            }
