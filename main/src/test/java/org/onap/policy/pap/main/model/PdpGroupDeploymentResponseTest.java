...
public class PdpGroupDeploymentResponseTest {
    ...
    public void test() {
        ...
        validator.validate(PdpGroupDeploymentResponse.class.getPackage().getName(),
                        new FilterClassName(PdpGroupDeploymentResponse.class.getName()));
    }
}
