...
public class IdentUtilTest {
    ...
    public void testConstants() {
        PfConceptKey key = new PfConceptKey(IdentUtil.NULL_INTERNAL_NAME, IdentUtil.NULL_INTERNAL_VERSION);
    ...
    public void testNameToExternal() {
        assertEquals(IdentUtil.NULL_EXTERNAL_NAME, IdentUtil.nameToExternal(IdentUtil.NULL_INTERNAL_NAME));
    ...
    public void testVersionToExternal() {
        assertEquals(IdentUtil.NULL_EXTERNAL_VERSION, IdentUtil.versionToExternal(IdentUtil.NULL_INTERNAL_VERSION));
    ...
    public void testToInternal() {
        ...
        assertEquals(IdentUtil.NULL_INTERNAL_NAME, target.getName());
        assertEquals("version-a", target.getVersion());

        // try with null version
        IdentUtil.toInternal("name-a", null, target);
        assertEquals("name-a", target.getName());
        assertEquals(IdentUtil.NULL_INTERNAL_VERSION, target.getVersion());
