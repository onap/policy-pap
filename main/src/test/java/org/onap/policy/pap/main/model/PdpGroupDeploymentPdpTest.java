...
public class PdpGroupDeploymentPdpTest {
    ...
    public void test() {
        ...
        validator.validate(PdpGroupDeploymentPdp.class.getPackage().getName(),
                        new FilterClassName(PdpGroupDeploymentPdp.class.getName()));
    }
}
