...
package org.onap.policy.pap.main.rest.provider;
...
import org.onap.policy.pap.main.rest.PdpGroupHealthCheckProvider;
...
public class TestPdpGroupHealthCheckProvider {
    ...
    private PdpGroups loadFile(final String fileName) {
        final File propFile = new File(ResourceUtils.getFilePath4Resource("provider/" + fileName));
        try {
