...
public class TestPdpGroupDeployProvider extends PdpGroupDeployProviderBase {
    ...
    public void setUp() throws Exception {
        ...
        when(dao.getFilteredPdpGroups(null, Arrays.asList(Pair.of(POLICY1_TYPE, POLICY1_TYPE_VERSION))))
                        .thenReturn(groups);
        when(dao.getLatestPdpGroups(GROUP1_NAME)).thenReturn(groups);
    ...
    public void testDeploySimplePolicies_NoGroups() throws Exception {
        when(dao.getFilteredPdpGroups(any(), any())).thenReturn(loadGroups("emptyGroups.json"));
    ...
    public void testGetPolicy() throws Exception {
        ...
        verify(dao, never()).getLatestPolicyList(POLICY1_NAME);
    }

    @Test
    public void testGetPolicy_NullVersion() throws Exception {
        when(dao.getLatestPolicyList(POLICY1_NAME)).thenReturn(loadPolicies("daoPolicyList.json"));

        Pair<Status, PdpGroupDeployResponse> pair = prov.deployPolicies(loadRequest("getPolicyReqNullVersion.json"));
        assertEquals(Status.OK, pair.getLeft());
        assertNull(pair.getRight().getErrorDetails());

        verify(dao).getLatestPolicyList(POLICY1_NAME);
    ...
    public void testGetGroup() throws Exception {
        when(dao.getFilteredPdpGroups(any(), any())).thenReturn(loadGroups("getGroupDao.json"));
    ...
    public void testUpgradeGroup() throws Exception {
        ...
        when(dao.getFilteredPdpGroups(any(), any())).thenReturn(loadGroups("upgradeGroupDao.json"));
    ...
    public void testUpgradeGroup_Multiple() throws Exception {
        ...
        when(dao.getFilteredPdpGroups(null, Arrays.asList(Pair.of(POLICY1_TYPE, POLICY1_TYPE_VERSION))))
                        .thenReturn(groups1);
        when(dao.getFilteredPdpGroups(null, Arrays.asList(Pair.of("typeB", POLICY1_TYPE_VERSION)))).thenReturn(groups2);
        when(dao.getFilteredPdpGroups(null, Arrays.asList(Pair.of("typeC", POLICY1_TYPE_VERSION)))).thenReturn(groups1);

        when(dao.getLatestPdpGroups(GROUP1_NAME)).thenReturn(groups1);
        when(dao.getLatestPdpGroups("groupB")).thenReturn(groups2);
    ...
    public void testUpgradeGroup_NoPdps() throws Exception {
        ...
        when(dao.getFilteredPdpGroups(any(), any())).thenReturn(loadGroups("upgradeGroup_NoPdpsDao.json"));
    ...
    public void testUpgradeGroup_NothingUpdated() throws Exception {
        ...
        when(dao.getFilteredPdpGroups(any(), any())).thenReturn(loadGroups("upgradeGroup_NothingUpdatedDao.json"));
