...
public class PdpClientTest {
    ...
    @Test
    public void testPdpClient_testGetTopic_testGetTopicSinks() {
    ...
    public void testGetTopicSinks() {
        /*
         * Create a plain PdpClient so that the real getTopicSinks will be invoked. We'll
         * use a topic name we know doesn't exist, so that we know the behavior to expect.
         */
        assertThatThrownBy(() -> new PdpClient("unknown topic")).isInstanceOf(PdpClientException.class);
    }
