...
public class MapperTest {
    ...
    private PdpSubGroup makeSubGroup(int count) {
        ...
        int inc = count + 1;
        subgroup.setPdpInstances(Arrays.asList(makePdpInstance(count), makePdpInstance(inc)));
    ...
    public void testPdpInstanceDetails() {
        ...
        // test populated object
        PdpInstanceDetails internal = makePdpInstance(1);
        compareWithInternal(internal, Mapper.toExternal(internal));
    ...
    // utility methods to compare expected values with actual values
    ...
    private static void compareWithExternal(org.onap.policy.models.pap.concepts.PdpDeployPolicies expected,
        ...
        compareList(expected.getPolicies(), actual.getPolicies(),
            (exp, act) -> compareWithExternal(exp.getName(), exp.getVersion(), act));
    }
    ...
    private static void compareWithExternal(String expectedName, String expectedVersion, PfConceptKey actual) {
