...
LABEL org.opencontainers.image.description="Policy PAP image based on OpenSuse"
...
ENV POLICY_HOME=/opt/app/policy/pap
...
ADD --chown=policy:policy /maven/lib/policy-pap.tar.gz $POLICY_HOME
