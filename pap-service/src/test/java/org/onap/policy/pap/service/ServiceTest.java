...
public class ServiceTest {
    ...
    @Test
    public void test() throws NexusRestWrapperException, MalformedURLException, IOException {
        PapService service = new PapService();
        // service.registerPdp("pdpName", "apexGroup");
    }
