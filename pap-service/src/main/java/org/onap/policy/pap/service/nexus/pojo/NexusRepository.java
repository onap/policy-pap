...
/**
 * The Class NexusRepository is a POJO that holds information on a repository in Maven. It is
 * populated directly from the JSON returned from a search in Maven.
 */
public class NexusRepository {
    ...
    public String toString() {
        return "NexusRepository [repositoryContentClass=" + repositoryContentClass
                + ", repositoryId=" + repositoryId + ", repositoryKind=" + repositoryKind
                + ", repositoryName=" + repositoryName + ", repositoryPolicy=" + repositoryPolicy
