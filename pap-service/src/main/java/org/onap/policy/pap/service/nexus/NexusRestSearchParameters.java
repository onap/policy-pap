...
/**
 * The Class NexusRestSearchParameters is used to specify the parameters of a search on Nexus. The
 * parameters are used to return the search part of the URL for the Maven search.
 */
public class NexusRestSearchParameters {
    ...
    private enum SearchType {
        ...
        FILTER, // Search using a group ID, artifact ID, version, packaging type, and/or classifier
                // filter
    ...
    public void useKeywordSearch(final String keyword) throws NexusRestWrapperException {
        if (isNullOrBlank(keyword)) {
            throw new NexusRestWrapperException(
                    "keyword must be specified for Nexus keyword searches");
        }
    ...
    public void useClassNameSearch(final String className) throws NexusRestWrapperException {
        if (isNullOrBlank(className)) {
            throw new NexusRestWrapperException(
                    "className must be specified for Nexus keyword searches");
        }
    ...
    public void useChecksumSearch(final String checksum) throws NexusRestWrapperException {
        if (isNullOrBlank(checksum)) {
            throw new NexusRestWrapperException(
                    "checksum must be specified for Nexus keyword searches");
        }
     ...
     */
    public NexusRestSearchParameters setRepositoryId(String repositoryId)
            throws NexusRestWrapperException {
        if (isNullOrBlank(repositoryId)) {
            throw new NexusRestWrapperException(
                    "repositoryId must be specified for Nexus keyword searches");
        }
    ...
    public NexusRestSearchParameters setFrom(int from) throws NexusRestWrapperException {
        if (from < 0) {
            throw new NexusRestWrapperException(
                    "from cannot be less than 0 for Nexus keyword searches");
        }
    ...
    public NexusRestSearchParameters setCount(int count) throws NexusRestWrapperException {
        if (count < 1) {
            throw new NexusRestWrapperException(
                    "count cannot be less than 1 for Nexus keyword searches");
        }
    ...
    public URI getSearchUri(final String nexusServerUrl) throws NexusRestWrapperException {
        if (isNullOrBlank(nexusServerUrl)) {
            throw new NexusRestWrapperException(
                    "nexusServerUrl must be specified for Nexus keyword searches");
        }

        // Use a URI builder to build up the search URI
        UriBuilder uriBuilder = UriBuilder.fromPath(nexusServerUrl).path(NEXUS_LUCENE_SEARCH_PATH);
        ...
        switch (searchType) {
            ...
            default:
                throw new NexusRestWrapperException(
                        "search parameters have not been specified for the NExus search");
        }
    ...
    public String toString() {
        return "NexusRestSearchParameters [searchType=" + searchType + ", keyword=" + keyword
                + ", groupId=" + groupId + ", artifactId=" + artifactId + ", version=" + version
                + ", packagingType=" + packagingType + ", classifier=" + classifier + ", className="
                + className + ", checksum=" + checksum + ", repositoryId=" + repositoryId
