...
/**
 * The Class NexusArtifact is a POJO that holds information on an Artifact in a Maven repository. It
 * is populated from the JSON response to a query on the repository. See:
...
public class NexusArtifact {
    ...
    public String toString() {
        return "NexusArtifact [groupId=" + groupId + ", artifactId=" + artifactId + ", version="
                + version + ", highlightedFragment=" + highlightedFragment + ", latestRelease="
                + latestRelease + ", latestReleaseRepositoryId=" + latestReleaseRepositoryId
                + ", latestSnapshot=" + latestSnapshot + ", latestSnapshotRepositoryId="
                + latestSnapshotRepositoryId + ", artifactHits=" + artifactHits + ", urlPath="
                + urlPath + "]";
    }
}
