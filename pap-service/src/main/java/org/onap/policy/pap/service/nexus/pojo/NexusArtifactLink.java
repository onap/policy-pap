...
/**
 * The Class NexusArtifactHit is a POJO that holds a link to an occurrence of an Artifact in a Maven
 * repository. It is populated from the JSON response to a query on the repository. See:
