...
/**
 * The Class NexusSearchResult holds the result of a search in Nexus. It is populated directly from
 * the JSON returned by the Nexus search.
 */
public class NexusSearchResult {
    ...
    public String toString() {
        return "NexusSearchResult [totalCount=" + totalCount + ", from=" + from + ", count=" + count
                + ", tooManyResults=" + tooManyResults + ", collapsed=" + collapsed
                + ", repoDetailsList=" + repoDetails + ", artifactList=" + data + "]";
    }
}
