...
public class DummyPapPlugin implements PapPlugin {
    ...
    @Override
    public Policy generatePolicy(int policyId, final String policyName, final String policyVersion,
        ...
        policy.setPolicyId(Integer.toString(policyId));
    ...
    public static List<File> getDrlFilesFromJar(final File theJar, final File targetDir) {
        ...
        try {
            zipInputStream = new ZipInputStream(new FileInputStream(theJar));
